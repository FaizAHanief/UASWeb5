  ...
  <div class="cog-bar cog-white cog-wide cog-padding cog-card">
    ...
    <div class="cog-right cog-hide-small">
	  ...
	  <?php if ($_SESSION['LoggedIn']){
			echo "<a href='index_profile.php' class='cog-bar-item cog-button'>".$uname."</a>
				  <a href='logout.php' class='cog-bar-item cog-button'>Log Out</a>";}
		else{
...
<div class="cog-content cog-padding" style="max-width:1564px">
  ...
  <!-- About Section -->
  <div class="cog-container cog-padding-32" id="about">
	<div class="cog-row-padding cog-grayscale">
		<h3 class="cog-border-bottom cog-border-light-grey cog-padding-16">About us</h3>
		<div class="cog-col l3 m10 cog-margin-bottom">
			<h3>Ami P.N.</h3>
			<p class="cog-opacity">CEO & Founder</p>
			<p>	NIM&nbsp&nbsp&nbsp:&nbsp4615040024<br>
				Kelas&nbsp:&nbspTMD5
			</p>
		</div>
		<div class="cog-col l3 m10 cog-margin-bottom">
			<h3>Faiz A.H.</h3>
			<p class="cog-opacity">Lead Programmer & Founder</p>
			<p> NIM&nbsp&nbsp&nbsp:&nbsp4615040015<br>
				Kelas&nbsp:&nbspTMD5
			</p>
		</div>
	</div>
