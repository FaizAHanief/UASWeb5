<?php
	...
	$query=mysqli_query($id_mysql,"select * from data_games where id='5'");
	$info_game=mysqli_fetch_array($query);
?>
...
<div class="cog-top">
  <div class="cog-bar cog-white cog-wide cog-padding cog-card">
    <a href="index.php" class="cog-bar-item cog-button"><b>Cogito Games</b> Studios</a>
    <!-- Float links to the right. Hide them on small screens -->
    <div class="cog-right cog-hide-small">
      <a href="index.php" class="cog-bar-item cog-button">Store</a>
	  <?php if ($_SESSION['LoggedIn']){
			echo "<a href='#login' class='cog-bar-item cog-button'>".$uname."</a>";}
		else{
			echo "<a href='login.php' class='cog-bar-item cog-button'>Sign In</a>";
		}
		?>
      <a href="about.php" class="cog-bar-item cog-button">About</a>
    </div>
  </div>
</div>
...
<header class="cog-display-container cog-content cog-wide" style="max-width:1500px;" id="home">
  <img class="cog-image" src="img/skyrim1.jpg" alt="Page1" width="1500" height="700">
</header>
...
<div class="cog-content cog-padding" style="max-width:1564px">
  ...
  <!-- About Section -->
  <div class="cog-container cog-padding-32">
    <h3 class="cog-border-bottom cog-border-light-grey cog-padding-16">About this game</h3>
    <p>The Elder Scrolls V: Skyrim is an open world action role-playing video game developed by Bethesda Game Studios and published by Bethesda Softworks. 
	It is the fifth main installment in The Elder Scrolls series, following The Elder Scrolls IV: Oblivion.
    </p>
	<p>The game's main story revolves around the player character and their quest to defeat Alduin the World-Eater, a dragon who is prophesied to destroy the world. 
	The game is set two hundred years after the events of Oblivion, and takes place in the fictional province of Skyrim. Over the course of the game, the player 
	completes quests and develops the character by improving skills. The game continues the open world tradition of its predecessors by allowing the player to travel 
	anywhere in the game world at any time, and to ignore or postpone the main storyline indefinitely.
	</p>
	<h3 class="cog-border-bottom cog-border-light-grey cog-padding-16">Informations</h3>
	<p>
		<?php echo "Title&emsp;:&emsp;".$info_game['Judul']."<br>
					Developer&emsp;:&emsp;".$info_game['Dev']."<br>
					Publisher&emsp;:&emsp;".$info_game['Publish']."<br>
					Genre&emsp;:&emsp;".$info_game['Genre']."<br>
					Release Year&emsp;:&emsp;".$info_game['Tahun'];
		?>
	</p>
  </div>

  <div class="cog-row-padding cog-grayscale">
    <div class="cog-col l4 m6 cog-margin-bottom">
      <h3>Minimum System Requirements</h3>
      <p>
		CPU: Dual Core 2.0 GHz or equivalent processor<br>
		RAM: 2 GB<br>
		OS: Windows 7/Vista/XP PC (32 or 64 bit)<br>
		VIDEO CARD: DirectX 9.0c compliant video card with 512 MB of RAM - NVIDIA GeForce 7600 GT & ATI Radeon X1800.<br>
		SOUND CARD: Yes<br>
		FREE DISK SPACE: 6 GB<br>
	</p>
    </div>
    <div class="cog-col l4 m6 cog-margin-bottom">
      <h3>Recommended System Requirements</h3>
      <p>		
		CPU: Quad-core Intel or AMD CPU<br>
		RAM: 4 GB<br>
		OS: Windows 7/Vista/XP PC (32 or 64 bit)<br>
		VIDEO CARD: DirectX 9.0c compatible NVIDIA or AMD ATI video card with 1 GB of RAM (NVIDIA GeForce GTX 260 or higher; ATI Radeon HD 4890 or higher)<br>
		SOUND CARD: Yes<br>
		FREE DISK SPACE: 6 GB<br>
	  </p>
    </div>
