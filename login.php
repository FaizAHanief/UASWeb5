...
<div class="cog-top">
  <div class="cog-bar cog-white cog-wide cog-padding cog-card">
    ...
    <div class="cog-right cog-hide-small">
	  ...
	  <a href='#signin' class='cog-bar-item cog-button'>Sign In</a>
...
<div class="cog-content cog-padding" style="max-width:1564px">
  ...
  <!-- About Section -->
  <div class="cog-container cog-padding-32" id="signin">
	<div class="cog-row-padding cog-grayscale">
		<h3 class="cog-border-bottom cog-border-light-grey cog-padding-16">Sign In</h3>
		<div class="cog-col l3 m10 cog-margin-bottom" id="login">
		</div>
		<div class="cog-col l3 m10 cog-margin-bottom" id="formulir">
			<p align="center">Don't have any account yet?</p>
			<p>
				<input class="cog-button cog-light-grey cog-block" type="button" value="Sign Up" onclick="buka('sign_up.php', 'formulir')">
			</p>
		</div>
	</div>
  </div>
